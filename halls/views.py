...
YOUTUBE_API_KEY = 'AIzaSyBBgMfv6yHaqqlj_s5NoBdUZrxRNszBgSM'
...
def dashboard(request):
    ...
    return render(request, 'halls/dashboard.html',{'hall':halls})
...
def add_video(request, pk):
    ...
    return render(request, 'halls/add_video.html', {'form': form, 'search_from': search_form, 'hall': hall})
